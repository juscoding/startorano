...
return array(
    ...
    "FEEDBACK_USERNAME_OR_PASSWORD_WRONG" => "Der eingebene Username oder das Passwort ist falsch. Bitte versuchen Sie es noch einmal.",
    ...
    "FEEDBACK_CAPTCHA_WRONG" => "Das eingegebene Captcha ist falsch.",
    ...
    "FEEDBACK_ACCOUNT_SUCCESSFULLY_CREATED" => "Dein Account wurde erfolgreich angelegt. Klicken Sie auf den Link in Ihrer E-Mail, um den Account zu bestätigen.",
    ...
    "FEEDBACK_VERIFICATION_MAIL_SENDING_SUCCESSFUL" => "Eine Mail zur Bestätigung des Accounts wurde versendet.",
    ...
    "FEEDBACK_PASSWORD_RESET_MAIL_SENDING_SUCCESSFUL" => "Eine E-Mail für die Zurücksetzung des Passworts versendet.",
